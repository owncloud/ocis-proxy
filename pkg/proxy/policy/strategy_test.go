...
func (t *testSettingsService) Set(ctx context.Context, in *proto.Record, opts ...client.CallOption) (*proto.Record, error) {
	if t.setFunc != nil {
...
func (t *testSettingsService) Get(ctx context.Context, in *proto.Query, opts ...client.CallOption) (*proto.Record, error) {
	if t.getFunc != nil {
...
func (t *testSettingsService) List(ctx context.Context, in *empty.Empty, opts ...client.CallOption) (*proto.Records, error) {
	if t.listFunc != nil {
...
func TestStrategy(t *testing.T) {
	strategy := &migrationStrategy{&testSettingsService{
